...
#endif
/* Tokens.  */
#define CIDADE_PRESTADOR 258
#define CIDADE_TOMADOR 259
#define VALOR_SERVICO 260
#define VALOR_ISS_RET 261
#define EOL 262
...
{
  "$end", "error", "$undefined", "CIDADE_PRESTADOR", "CIDADE_TOMADOR",
  "VALOR_SERVICO", "VALOR_ISS_RET", "EOL", "$accept", "PROGRAMA",
...
#line 33 "main.y" /* yacc.c:1646  */
    {
		strcpy (strings_printar[1], (yyvsp[0].string));
		}
...
#line 37 "main.y" /* yacc.c:1646  */
    {
		strcpy (strings_printar[0], (yyvsp[0].string));
		}
...
#line 41 "main.y" /* yacc.c:1646  */
    {
		strcpy (strings_printar[2], (yyvsp[0].string));
		}
...
#line 45 "main.y" /* yacc.c:1646  */
    {
		strcpy (strings_printar[3], (yyvsp[0].string));
		}
